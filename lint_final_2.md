...
C:\Users\User\.gemini\antigravity\scratch\interpretation-platform\hooks\use-webrtc.ts
  ...
  215:60   error    Unexpected any. Specify a different type                                                                                                                                                                                                                         @typescript-eslint/no-explicit-any
  254:26   warning  'e' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
  279:27   error    Unexpected any. Specify a different type                                                                                                                                                                                                                         @typescript-eslint/no-explicit-any
  292:71   warning  The ref value 'peersRef.current' will likely have changed by the time this effect cleanup function runs. If this ref points to a node rendered by React, copy 'peersRef.current' to a variable inside the effect, and use that variable in the cleanup function  react-hooks/exhaustive-deps
  296:8    warning  React Hook useEffect has missing dependencies: 'initialConfig.audioDeviceId', 'initialConfig.cameraOn', 'initialConfig.micOn', 'initialConfig.videoDeviceId', 'joinChannel', 'supabase', and 'syncToState'. Either include them or remove the dependency array   react-hooks/exhaustive-deps
  327:8    warning  React Hook useEffect has a missing dependency: 'updateMetadata'. Either include it or remove the dependency array                                                                                                                                                react-hooks/exhaustive-deps
  343:70   warning  'e' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
  347:78   error    Unexpected any. Specify a different type                                                                                                                                                                                                                         @typescript-eslint/no-explicit-any
  381:48   error    Unexpected any. Specify a different type                                                                                                                                                                                                                         @typescript-eslint/no-explicit-any
  432:82   warning  'e' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
  442:21   error    Unexpected any. Specify a different type                                                                                                                                                                                                                         @typescript-eslint/no-explicit-any
  475:85   warning  'e' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
  477:86   warning  'e' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
  486:81   warning  'e' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
  500:42   error    Unexpected any. Specify a different type                                                                                                                                                                                                                         @typescript-eslint/no-explicit-any
  500:73   error    Unexpected any. Specify a different type                                                                                                                                                                                                                         @typescript-eslint/no-explicit-any
  500:106  error    Unexpected any. Specify a different type                                                                                                                                                                                                                         @typescript-eslint/no-explicit-any
  515:100  warning  'e' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
  523:80   warning  'e' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
  529:18   warning  'e' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
  569:30   warning  'k' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
  569:33   error    Unexpected any. Specify a different type                                                                                                                                                                                                                         @typescript-eslint/no-explicit-any
  569:38   warning  'd' is defined but never used                                                                                                                                                                                                                                    @typescript-eslint/no-unused-vars
...
✖ 178 problems (71 errors, 107 warnings)
